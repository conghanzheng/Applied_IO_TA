...
- [`pdf`](https://drive.google.com/file/d/13np6QRZarC0UikP4_WQ4-riGk7wP14P4/view?usp=sharing); 
- [`html`](https://nagato0376.github.io/AIDS-Page/) (contains R code chunks).
...
## Restrictions on paramters
## symmetry is assumed (symmetry implies homogeneity)
...
## LA-AIDS estimation, returning the coefficients
...
## Function to calculate the translog price lnP
...
## Add intial values of translog prices to data
